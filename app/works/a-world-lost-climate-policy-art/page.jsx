...
const slides = [
  "/images/works/a-world-lost-climate-policy-art/fig_1.jpg",
  // "/images/works/a-world-lost-climate-policy-art/fig_2.jpg",
  "/images/works/a-world-lost-climate-policy-art/fig_3.jpg",
]
          ...
          <div className="flex gap-20">
            <div className="text-left flex-1">
              <div className="flex gap-1 items-center justify-start">
                ...
                <Link href="/" className="font-italiana text-md md:text-xl">
